...
--[[
    ...
    This library is entirely written by MNoya and the others responsible for
    this library, though some local changes have been done by me (Arild)
    to fit my usage better.
]]
...
function BuildingHelper:InitGNV()
    -- Added
    -- This has to be done as this module will NOT work properly
    -- with the current maximum and minimum world bounds.
    local oldGetWorldMinX = GetWorldMinX
    local oldGetWorldMaxX = GetWorldMaxX
    local oldGetWorldMinY = GetWorldMinY
    local oldGetWorldMaxY = GetWorldMaxY

    GetWorldMinX = function() return -8192.0 end
    GetWorldMaxX = function() return 8192.0 end
    GetWorldMinY = function() return -8192.0 end
    GetWorldMaxY = function() return 8192.0 end
    --
    ...
    for y=boundY1,boundY2 do
        ...
        -- Added
        --print(freeAtY.." free squares at line "..y.." ("..tostring(y*64)..") ")
        --
    ...
    -- Added
    print("Printing data as sent over the network:")
    print(gnv_string)
    --
    ...
    -- Added
    GetWorldMinX = oldGetWorldMinX
    GetWorldMaxX = oldGetWorldMaxX
    GetWorldMinY = oldGetWorldMinY
    GetWorldMaxY = oldGetWorldMaxY
    --
end
...
function BuildingHelper:SendGNV(args)
    ...
    if playerID then
        ...
        if player then
            ...
            -- Added
            print("Length of encoded: "..BuildingHelper.Encoded:len())
            --
        end
    end
end
